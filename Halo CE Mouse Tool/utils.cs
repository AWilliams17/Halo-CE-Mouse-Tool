...
namespace Halo_CE_Mouse_Tool {
    ...
    */
    public static class utils {
        public static void WriteHaloMemory(SettingsHandler settings) { //Calls WriteMemory with selected settings.
        ...
        public static void parse_sensitivity(TextBox origin, char sens, SettingsHandler settings) { //For performing validation on the sensitivity text boxes.
            float conv_float;
            if (origin.Text != "") {
        ...
        public static void check_if_blank(TextBox origin, SettingsHandler settings) { //Check if the sensitivity textbox is blank or not. Prevent user from leaving if it is.
            if (origin.Text == "") {
                origin.Focus();
                SoundHandler.sound_error(settings);
        ...
        public static void CheckForUpdates(SettingsHandler settings) { //For checking for updates...
        ...
        public static void keybind_handle(SettingsHandler settings) { //Detects if the hotkey is pressed or not. IDK if there's a better way of doing this or not.
